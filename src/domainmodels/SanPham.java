...
public class SanPham {
    ...
    public SanPham(String id, String masp, String tenSp, String XuatXu, String ThuongHieu, String TheTich, String NongDoCon, String ngaySanXuat, String ngayHetHan, String maVach, int soLonMoiThung, float giaBanTheoThung, float giaBanTheoLon, int soLuongThung, int soLuongLon, String hinhAnh, int trangThai) {
        this.id = id;
        this.masp = masp;
        this.tenSp = tenSp;
        this.XuatXu = XuatXu;
